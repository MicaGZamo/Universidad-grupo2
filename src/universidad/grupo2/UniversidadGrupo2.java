...
public class UniversidadGrupo2 {
 ...
 //     "----------------- MATERIA DATA E INSCRIPCION DATA -----------------" 
        ...
        // Listado de inscripciones de cada alumno
        ...
        // Listado de materias cursadas por alumnos
        ...
        // Listado de materias no cursadas
        ...
        // Método para borrar inscripcion
        id.borrarInscripcion(1, 1);

        // Actualizar nota   
        id.actualizarNota(4, 3, 10);
        
        // Listado de alumnos inscriptos en una materia
